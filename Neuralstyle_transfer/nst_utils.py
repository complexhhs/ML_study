...
# Config is meaning less
class CONFIG:
	IMAGE_WIDTH = 516
	IMAGE_HEIGHT = 371
	COLOR_CHANNELS = 3
	NOISE_RATIO = 0.65
	MEANS = np.array([127.5,127.5,127.5]).reshape((1,1,1,3))
...
def load_vgg_model(path):
	...
	graph = {}
	graph['input'] = tf.Variable(np.zeros((1,CONFIG.IMAGE_HEIGHT,CONFIG.IMAGE_WIDTH,CONFIG.COLOR_CHANNELS)),dtype = tf.float32)
